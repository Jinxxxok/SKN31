...
def get_human_message(text_message: str, bytes_data:bytes=None, mime_type=None, filename=None, history:list=None) -> list[BaseMessage]:
    ...
    if bytes_data is not None:
        d_type = "image" if "image" in mime_type else "file" # type값 조회
